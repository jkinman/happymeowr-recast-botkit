...
process.env['DEBUG'] = 'botkit:main botkit:incoming_webhooks botkit:webserver';
...
var client = new recastai.Client(process.env.REQUEST_TOKEN, 'EN');
// var client = new recastai(process.env.REQUEST_TOKEN, 'EN');
// var request = new recastai.request(process.env.REQUEST_TOKEN);
// debug( 'recast', client );
